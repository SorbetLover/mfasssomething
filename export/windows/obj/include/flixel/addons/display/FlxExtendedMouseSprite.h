...
#define INCLUDED_flixel_addons_display_FlxExtendedMouseSprite
...
class HXCPP_CLASS_ATTRIBUTES FlxExtendedMouseSprite_obj : public  ::flixel::FlxSprite_obj
{
	public:
		typedef  ::flixel::FlxSprite_obj super;
		typedef FlxExtendedMouseSprite_obj OBJ_;
		FlxExtendedMouseSprite_obj();

	public:
		enum { _hx_ClassId = 0x443bac4e };

		void __construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y, ::Dynamic SimpleGraphic);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="flixel.addons.display.FlxExtendedMouseSprite")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"flixel.addons.display.FlxExtendedMouseSprite"); }
		static ::hx::ObjectPtr< FlxExtendedMouseSprite_obj > __new(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y, ::Dynamic SimpleGraphic);
		static ::hx::ObjectPtr< FlxExtendedMouseSprite_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y, ::Dynamic SimpleGraphic);
		...
		::String __ToString() const { return HX_("FlxExtendedMouseSprite",9f,c2,9a,69); }
		...
		::Dynamic disableMouseSnap_dyn();
		 ...
		 ::flixel::addons::display::FlxMouseSpring enableMouseSpring(::hx::Null< bool >  onPressed,::hx::Null< bool >  retainVelocity,::hx::Null< Float >  tension,::hx::Null< Float >  friction,::hx::Null< Float >  gravity, ::flixel::math::FlxBasePoint offset);
		...
		bool isOverPixelPerfect( ::flixel::math::FlxBasePoint mouse,bool pixelPerfect,int alphaThreshold);
		::Dynamic isOverPixelPerfect_dyn();
...
#endif /* INCLUDED_flixel_addons_display_FlxExtendedMouseSprite */ 
