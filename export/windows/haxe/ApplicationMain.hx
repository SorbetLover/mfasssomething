...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("mfasssomething shit", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("mfasssomething shit", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "19";
		app.meta["company"] = "umc4r4aa3";
		app.meta["file"] = "mfasssomething shit";
		app.meta["name"] = "mf ass thing";
